...
const sampleStringProblem = {
  ...
  hints:
    "Use two pointers and ignore non-alphanumeric characters while comparing.",
  editorial:
    "Normalize the string and compare using two pointers.",
  ...
  examples: {
    ...
    PYTHON: {
      input: 'race a car',
      output: "false",
      explanation: "Not a palindrome after cleanup.",
    },
    JAVA: {
      input: ' ',
      output: "true",
...
//INPUT + OUTPUT HANDLING (REQUIRED)
const readline = require("readline");
const rl = readline.createInterface({
  input: process.stdin,
  output: process.stdout,
